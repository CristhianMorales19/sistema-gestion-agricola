...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ 
  ...
  const sidebarItems = React.useMemo(() => [
    ...
    { id: 'work-conditions', icon: <Cloud />, text: 'Condiciones Climáticas', active: currentView === 'work-conditions' },
    { id: 'parcelas', icon: <Terrain />, text: 'Gestión de Parcelas', active: currentView === 'parcelas' },
