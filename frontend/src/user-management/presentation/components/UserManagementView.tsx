...
import { Refresh, PersonAdd, Edit, Search } from "@mui/icons-material";
...
export const UserManagementView: React.FC = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      {/* Filtros */}
      <Card
        sx={{ mb: 3, backgroundColor: "#1e293b", border: "1px solid #334155" }}
      >
        <CardContent>
      ...
      >
        <DialogTitle sx={{ borderBottom: "1px solid #334155" }}>
          ...
          {selectedUser?.user.name ||
            selectedUser?.localUserData?.username ||
            "Usuario"}
        </DialogTitle>
        ...
        <DialogActions sx={{ borderTop: "1px solid #334155", pt: 2 }}>
          <Button onClick={handleCloseRoleDialog} sx={{ color: "#64748b" }}>
            Cancelar
          </Button>
          <Button
