...
async function main() {
  ...
  const permisos = await prisma.mom_permiso.createMany({
    data: [
      ...
      {
        nombre: "gestionar_nominas",
        categoria: "nominas",
        descripcion: "Gestionar nóminas",
        created_at: new Date(),
        created_by: 1,
      },
      {
        nombre: "gestionar_parcelas",
        categoria: "parcelas",
        descripcion: "Gestionar parcelas",
        created_at: new Date(),
        created_by: 1,
      },
      {
      ...
      {
        nombre: "gestionar_condiciones_trabajo",
        categoria: "condiciones_trabajo",
        descripcion: "Gestionar condiciones de trabajo",
        created_at: new Date(),
        created_by: 1,
      },
    ],
  ...
  console.log("📊 Resumen:");
  console.log(
    `   - ${await prisma.mom_trabajador.count()} trabajadores creados`,
  );
