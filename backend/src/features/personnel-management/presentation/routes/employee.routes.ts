    ...
    async (req, res) => {
        try {
            ...
            const mappedTrabajadores = trabajadores.map(t => ({
                ...
                cargo: t.mot_info_laboral[0]?.cargo,
    ...
    async (req, res) => {
        try {
            ...
            const laboralData: any = {
                ...
                salario_base: salario_base && !isNaN(parseFloat(String(salario_base))) ? parseFloat(String(salario_base)) : (existingInfo?.salario_base ?? 0),
                codigo_nomina: req.body.codigo_nomina ? String(req.body.codigo_nomina) : (existingInfo ? existingInfo.codigo_nomina : null),
                salario_bruto: req.body.salario_bruto && !isNaN(parseFloat(String(req.body.salario_bruto))) ? parseFloat(String(req.body.salario_bruto)) : (existingInfo?.salario_bruto ?? null),
                rebajas_ccss: req.body.rebajas_ccss && !isNaN(parseFloat(String(req.body.rebajas_ccss))) ? parseFloat(String(req.body.rebajas_ccss)) : (existingInfo?.rebajas_ccss ?? null),
                otras_rebajas: req.body.otras_rebajas && !isNaN(parseFloat(String(req.body.otras_rebajas))) ? parseFloat(String(req.body.otras_rebajas)) : (existingInfo?.otras_rebajas ?? null),
                salario_por_hora: req.body.salario_por_hora && !isNaN(parseFloat(String(req.body.salario_por_hora))) ? parseFloat(String(req.body.salario_por_hora)) : (existingInfo?.salario_por_hora ?? null),
                horas_ordinarias: req.body.horas_ordinarias && !isNaN(parseFloat(String(req.body.horas_ordinarias))) ? parseFloat(String(req.body.horas_ordinarias)) : (existingInfo?.horas_ordinarias ?? null),
                horas_extras: req.body.horas_extras && !isNaN(parseFloat(String(req.body.horas_extras))) ? parseFloat(String(req.body.horas_extras)) : (existingInfo?.horas_extras ?? null),
                horas_otras: req.body.horas_otras && !isNaN(parseFloat(String(req.body.horas_otras))) ? parseFloat(String(req.body.horas_otras)) : (existingInfo?.horas_otras ?? null),
                vacaciones_monto: req.body.vacaciones_monto && !isNaN(parseFloat(String(req.body.vacaciones_monto))) ? parseFloat(String(req.body.vacaciones_monto)) : (existingInfo?.vacaciones_monto ?? null),
                incapacidad_monto: req.body.incapacidad_monto && !isNaN(parseFloat(String(req.body.incapacidad_monto))) ? parseFloat(String(req.body.incapacidad_monto)) : (existingInfo?.incapacidad_monto ?? null),
                lactancia_monto: req.body.lactancia_monto && !isNaN(parseFloat(String(req.body.lactancia_monto))) ? parseFloat(String(req.body.lactancia_monto)) : (existingInfo?.lactancia_monto ?? null),
                fecha_ultima_actualizacion_at: new Date(),
