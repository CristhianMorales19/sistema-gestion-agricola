...
export const ROLE_PERMISSIONS: Record<string, AgroManoPermission[]> = {
    [AGROMANO_ROLES.ADMIN_AGROMANO]: [
        ...
        'metas:set', 'metas:track', 'parcelas:create', 'parcelas:read', 'parcelas:read:all', 'parcelas:update', 'parcelas:delete',
        'cultivos:read', 'cultivos:update', 'cultivos:track', 'cosechas:register', 'cosechas:read',
        'clima:read', 'clima:create', 'clima:update', 'clima:delete', 'clima:reports', 'clima:dashboard', 'clima:export',
    ...
    [AGROMANO_ROLES.SUPERVISOR_CAMPO]: [
        ...
        // Clima
        'clima:read', 'clima:create', 'clima:update', 'clima:reports', 'clima:dashboard',
        // Productividad
        ...
        // Cultivos
        'parcelas:read', 'parcelas:read:all', 'parcelas:update', 'cultivos:read', 'cultivos:update',
