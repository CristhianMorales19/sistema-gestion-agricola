...
router.get("/profile", checkJwt, async (req, res) => {
  ...
  try {
    ...
    const permisosObject: Record<string, boolean> = {
      // Usuarios
      gestionar_usuarios:
        permisosArray.includes("gestionar_usuarios") ||
        permisosArray.includes("usuarios:manage"),
      consultar_usuarios:
        permisosArray.includes("consultar_usuarios") ||
        permisosArray.includes("usuarios:read"),
      // Personal
      gestionar_personal:
        permisosArray.includes("gestionar_personal") ||
        permisosArray.includes("trabajadores:create") ||
        permisosArray.includes("trabajadores:update:all"),
      consultar_personal:
        permisosArray.includes("consultar_personal") ||
        permisosArray.includes("trabajadores:read:all") ||
        permisosArray.includes("trabajadores:read:own"),
      // Asistencia
      gestionar_asistencia:
        permisosArray.includes("gestionar_asistencia") ||
        permisosArray.includes("asistencia:manage"),
      consultar_asistencia:
        permisosArray.includes("consultar_asistencia") ||
        permisosArray.includes("asistencia:read"),
      // Condiciones de trabajo
      gestionar_condiciones_trabajo:
        permisosArray.includes("gestionar_condiciones_trabajo") ||
        permisosArray.includes("work_conditions:manage") ||
        permisosArray.includes("condiciones_trabajo:write"),
      // Parcelas
      "parcelas:read":
        permisosArray.includes("parcelas:read") ||
        permisosArray.includes("parcelas:read:all") ||
        permisosArray.includes("parcelas:read:own"),
      "parcelas:update":
        permisosArray.includes("parcelas:update") ||
        permisosArray.includes("parcelas:update:all"),
      "parcelas:create": permisosArray.includes("parcelas:create"),
      "parcelas:delete": permisosArray.includes("parcelas:delete"),
      // Nómina
      gestionar_nomina:
        permisosArray.includes("gestionar_nomina") ||
        permisosArray.includes("nomina:manage"),
      consultar_nomina:
        permisosArray.includes("consultar_nomina") ||
        permisosArray.includes("nomina:read"),
      // Productividad
      gestionar_productividad:
        permisosArray.includes("gestionar_productividad") ||
        permisosArray.includes("productividad:manage"),
      consultar_productividad:
        permisosArray.includes("consultar_productividad") ||
        permisosArray.includes("productividad:read"),
      // Reportes
      gestionar_reportes:
        permisosArray.includes("gestionar_reportes") ||
        permisosArray.includes("reportes:manage"),
      consultar_reportes:
        permisosArray.includes("consultar_reportes") ||
        permisosArray.includes("reportes:read"),
      // Configuración
      gestionar_configuracion:
        permisosArray.includes("gestionar_configuracion") ||
        permisosArray.includes("configuracion:manage"),
      consultar_configuracion:
        permisosArray.includes("consultar_configuracion") ||
        permisosArray.includes("configuracion:read"),
    };
    ...
    console.log(
      `📋 Perfil solicitado: ${authUserResponse.email} con ${permisosArray.length} permisos`,
    );
    console.log(`🔑 Permisos del usuario:`, permisosArray);
    console.log(
      `🔑 Permisos de parcelas: parcelas:read=${permisosObject["parcelas:read"]}`,
    );
