...
-- ================================================================
-- DATOS INICIALES ESPECÍFICOS PARA PIÑA
-- ================================================================

-- Crear cultivo de piña
...
SET @cultivo_pina_id = (SELECT cultivo_id FROM mom_cultivo WHERE nombre = 'Piña' LIMIT 1);

-- Crear tareas específicas para piña
...
-- Verificar datos específicos de piña
SELECT 
    '=== DATOS INICIALES DE PIÑA ===' as info;

SELECT 'Cultivos:' as tipo, COUNT(*) as total FROM mom_cultivo WHERE nombre LIKE '%Piña%'
UNION ALL
...
SELECT 
    '✅ BASE DE DATOS AGROMANO CONFIGURADA CORRECTAMENTE' as resultado,
    '🔐 Usuarios admin listos para Auth0' as siguiente_paso,
    '📧 Usar los mismos emails en Auth0 que aparecen arriba' as importante;
